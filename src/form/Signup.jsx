                    ...
                    <form className="space-y-5 mt-7" onSubmit={handleSubmit(submit)}>
                        <div className="grid grid-cols-2 gap-5">
                            <div className="form-control w-full">
                                ...
                                <input
                                    className="border border-sky-600 rounded-2xl p-2" placeholder='name'
                            ...
                            <div className="form-control w-full">
                                ...
                                <input type="email"
                                    className="border border-sky-600 rounded-2xl p-2" placeholder='email'
                            ...
                            <div className="form-control w-full">
                                ...
                                <input
                                    className="border border-sky-600 rounded-2xl p-2" type="number" placeholder='number'
                            ...
                            <div className="form-control w-full">
                                ...
                                <input
                                    className="border border-sky-600 rounded-2xl p-2" placeholder='password'
                                    {...register('password', {
                                        required: true,
                                        pattern: /(?=.*[A-Z])(?=.*[0-9])(?=.*[a-z])/,
                                        minLength: 6
                            ...
                            <div className="form-control w-full">
                                ...
                                <input
                                    className="border border-sky-600 rounded-2xl p-2" placeholder='confirm password'
