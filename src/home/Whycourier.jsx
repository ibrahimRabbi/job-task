...
const Whycourier = () => {
    return (
        <section className='lg:w-[90%] w-[96%] mx-auto lg:mt-40 mt-20'>
            ...
            <div className='flex lg:flex-row flex-col justify-around gap-10 mt-7'>
                <div className=' border-green-500 rounded-lg lg:w-[52%] w-[96%] mx-auto border'>
